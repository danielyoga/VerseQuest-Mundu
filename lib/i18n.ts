...
export const messages = {
  en: {
    ...
    adminMobilePreviewOn: "Mobile preview — click to exit",
    adminMobilePreviewOff: "Preview on mobile",

    editorPlaceholder: "Write the devotion...",
    editorBoldAria: "Bold",
    editorItalicAria: "Italic",
    editorH2Aria: "Heading 2",
    editorH3Aria: "Heading 3",
    editorParagraphAria: "Paragraph",
    editorBulletListAria: "Bulleted list",
    editorNumberedListAria: "Numbered list",
    editorQuoteAria: "Quote",
    editorUndoAria: "Undo",
    editorRedoAria: "Redo",
  ...
  id: {
    ...
    firmanModalSubtitleDefault: "Centang setiap perbuatan yg sudah anda lakukan hari ini",
    firmanModalCheckAllHint: "Centang yang sesuai hari ini — simpan kapan saja",
    firmanSubmitPoll: "Sudah menjadi pelaku Firman 🔥",
    ...
    adminMobilePreviewOn: "Pratinjau seluler — klik untuk keluar",
    adminMobilePreviewOff: "Pratinjau di seluler",

    editorPlaceholder: "Tulis renungannya...",
    editorBoldAria: "Tebal",
    editorItalicAria: "Miring",
    editorH2Aria: "Judul 2",
    editorH3Aria: "Judul 3",
    editorParagraphAria: "Paragraf",
    editorBulletListAria: "Daftar berpoin",
    editorNumberedListAria: "Daftar bernomor",
    editorQuoteAria: "Kutipan",
    editorUndoAria: "Urungkan",
    editorRedoAria: "Ulangi",
