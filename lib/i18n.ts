...
export const messages = {
  en: {
    ...
    prayerWallEmpty: "No prayer requests yet. Be the first!",
    ...
    prayerModalTitle: "🙏 Add Prayer Request",
    prayerModalClose: "Close",
    prayerModalFieldLabel: "Prayer Request",
    prayerModalPlaceholder: "Write your prayer request...",
    prayerModalShowName: "Show my name",
    prayerModalShowNameHint: "Your name will be visible to all community members",
    prayerModalAnonHint: "Your prayer will appear as Anonymous",
    prayerModalSubmit: "Send Prayer",
    prayerModalSubmitting: "Sending...",
    prayerModalNetworkError: "Cannot connect. Check your internet connection.",
  },
  id: {
    loading: "Memuat…",
    ...
    prayerWallSubtitle: "Bagikan pergumulan doamu. Semua anggota bisa mendoakan satu sama lain.",
    prayerWallEmpty: "Belum ada permintaan doa. Jadilah yang pertama!",
    ...
    prayerModalTitle: "🙏 Tambah Permintaan Doa",
    prayerModalClose: "Tutup",
    prayerModalFieldLabel: "Permintaan Doa",
    prayerModalPlaceholder: "Tulis permintaan doa...",
    prayerModalShowName: "Tampilkan nama saya",
    prayerModalShowNameHint: "Nama kamu akan terlihat oleh semua anggota komunitas",
    prayerModalAnonHint: "Doa kamu akan tampil sebagai Anonim",
    prayerModalSubmit: "Kirim Doa",
    prayerModalSubmitting: "Mengirim...",
    prayerModalNetworkError: "Tidak dapat terhubung. Periksa koneksi internet.",
  },
} as const;
